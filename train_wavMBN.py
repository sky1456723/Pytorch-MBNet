...
from dataset import get_dataloader, get_dataset, get_feature_dataset 
from model import MBNet, wavMBNet
...
def main(
    ...
    train_set = get_feature_dataset(data_path, "training_data.csv", vcc18 = True, idtable = os.path.join(save_dir, 'idtable.pkl'))
    valid_set = get_feature_dataset(data_path, "valid_data.csv", vcc18 = True, valid = True, idtable = os.path.join(save_dir, 'idtable.pkl'))
    test_set = get_feature_dataset(data_path, "testing_data.csv", vcc18 = True, valid = True, idtable = os.path.join(save_dir, 'idtable.pkl'))
    ...
    model = wavMBNet(num_judges = 5000).to(device)
